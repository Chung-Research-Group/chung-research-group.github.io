...
The site does not fetch, generate, store, or display publication artwork.
Slack-approved publications require bibliographic metadata only, and the public
Publications page uses a compact number-and-bibliography layout.
