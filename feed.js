...
const PUB_TOPICS = {
  '72': ['Review'], '71': ['Machine Learning', 'LLM', 'Materials Data', 'Transport', 'electrolytes'], '70': ['Review'],
  ...
  '56': ['GCMC', 'Machine Learning', 'Adsorption', 'COFs'], '55': ['GCMC', 'Process & Systems', 'Adsorption', 'zeolites'], '54': ['GCMC', 'Machine Learning', 'Infrastructure', 'Materials Data', 'Adsorption', 'MOFs', 'COFs'], '53': ['Reaction', 'MOFs'],
  '52': ['GCMC', 'Machine Learning', 'Adsorption', 'MOFs', 'COFs'], '51': ['GCMC', 'Adsorption', 'PAFs'], '50': ['DFT', 'Machine Learning', 'Materials Data', 'molecules'], '49': ['Transport', 'Reaction', 'oxides', 'carbons', 'perovskites'],
  ...
  '41': ['Adsorption', 'Reaction', '2D', 'zeolites'], '40': ['GCMC', 'Adsorption', 'MOFs', 'carbons'], '39': ['DFT', 'Adsorption', 'Reaction', 'molecules'], '38': ['GCMC', 'Adsorption', 'MOFs'],
  ...
  '27': ['Process & Systems', 'Reaction'], '26': ['Machine Learning', 'Materials Data', 'Adsorption', 'MOFs'], '25': ['Machine Learning', 'Process & Systems'], '24': ['Transport', 'Reaction', 'Thermodynamics', 'molecules'],
  '23': ['DFT', 'Adsorption', 'Reaction', 'carbons'], '22': ['Infrastructure', 'Materials Data', 'MOFs'], '21': ['Review'],
  '20': ['DFT', 'Adsorption', 'MOFs'], '19': ['GCMC', 'Adsorption', 'MOFs', 'carbons'], '18': ['GCMC', 'Process & Systems', 'Adsorption', 'MOFs'], '17': ['Review'],
  '16': ['Adsorption', 'Reaction', '2D', 'MOFs'], '15': ['Adsorption', 'Reaction', 'MOFs'], '14': ['GCMC', 'Adsorption', 'MOFs'],
  '13': ['GCMC', 'Process & Systems', 'Adsorption', 'MOFs', 'zeolites'], '12': ['GCMC', 'Adsorption', 'MOFs'], '11': ['DFT', 'Materials Data', 'MOFs'], '10': ['Reaction', 'MOFs'],
