...
const PUB_TOPICS = {
  ...
  '69': ['Process & Systems', 'Adsorption', 'Transport', 'reticular materials'], '68': ['Infrastructure', 'Process & Systems', 'Adsorption', 'Thermodynamics'], '67': ['GCMC', 'Process & Systems', 'Adsorption', 'reticular materials'],
  '66': ['GCMC', 'Process & Systems', 'Adsorption', 'Thermodynamics'], '65': ['GCMC', 'Adsorption', 'reticular materials'], '64': ['Process & Systems', 'Adsorption', 'carbons'], '63': ['Machine Learning', 'Materials Data', 'reticular materials'],
  '62': ['GCMC', 'Machine Learning', 'Adsorption', 'reticular materials'], '61': ['Transport', 'polymers', 'membranes'], '60': ['GCMC', 'Infrastructure', 'Materials Data', 'Machine Learning', 'Process & Systems', 'Adsorption', 'reticular materials'],
  '59': ['GCMC', 'Process & Systems', 'Adsorption', 'Transport', 'reticular materials'], '58': ['DFT', 'Transport', 'Reaction', 'Electrochemistry', 'reticular materials'], '57': ['Reaction', 'Transport', 'Electrochemistry', 'oxides', 'polymers'],
  '56': ['GCMC', 'Machine Learning', 'Adsorption', 'reticular materials'], '55': ['GCMC', 'Process & Systems', 'Adsorption', 'zeolites'], '54': ['GCMC', 'Machine Learning', 'Infrastructure', 'Materials Data', 'Adsorption', 'reticular materials'], '53': ['Reaction', 'reticular materials'],
  '52': ['GCMC', 'Machine Learning', 'Adsorption', 'reticular materials'], '51': ['GCMC', 'Adsorption', 'reticular materials'], '50': ['DFT', 'Machine Learning', 'Materials Data', 'molecules'], '49': ['Transport', 'Reaction', 'Electrochemistry', 'oxides', 'carbons', 'perovskites'],
  '48': ['Review'], '47': ['Reaction', 'reticular materials'], '46': ['GCMC', 'Machine Learning', 'Materials Data', 'Process & Systems', 'Adsorption', 'reticular materials'], '45': ['Reaction', 'reticular materials'],
  '44': ['Reaction', 'Transport', 'Electrochemistry', 'oxides', 'polymers'], '43': ['Infrastructure', 'Adsorption'], '42': ['Machine Learning', 'Materials Data', 'Adsorption', 'reticular materials'],
  ...
  '33': ['GCMC', 'Materials Data', 'Process & Systems', 'Adsorption', 'reticular materials'], '32': ['GCMC', 'Adsorption'],
  '31': ['Transport', 'carbons', 'membranes'], '30': ['DFT', 'GCMC', 'MD', 'Materials Data', 'Process & Systems', 'Adsorption', 'reticular materials'], '29': ['DFT', '2D', 'carbons'], '28': ['Machine Learning', 'Process & Systems'],
  '27': ['Process & Systems', 'Reaction'], '26': ['Machine Learning', 'Materials Data', 'Adsorption', 'reticular materials'], '25': ['Machine Learning', 'Process & Systems'], '24': ['Transport', 'Reaction', 'Thermodynamics', 'molecules'],
  '23': ['DFT', 'Adsorption', 'Reaction', 'carbons'], '22': ['Infrastructure', 'Materials Data', 'reticular materials'], '21': ['Review'],
  '20': ['DFT', 'Adsorption', 'reticular materials'], '19': ['GCMC', 'Adsorption', 'reticular materials', 'carbons'], '18': ['GCMC', 'Process & Systems', 'Adsorption', 'reticular materials'], '17': ['Review'],
  ...
  '13': ['GCMC', 'Process & Systems', 'Adsorption', 'reticular materials', 'zeolites'], '12': ['GCMC', 'Adsorption', 'reticular materials'], '11': ['DFT', 'Materials Data', 'reticular materials'], '10': ['Reaction', 'reticular materials'],
