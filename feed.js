...
const PUB_TOPICS = {
  '72': ['Review'], '71': ['Machine Learning', 'LLM', 'Data Curation', 'Diffusion', 'Electrochemistry', 'Electrolytes', 'Secondary Battery'], '70': ['Review'],
  '69': ['Adsorption', 'Diffusion', 'Chiller', 'Reticular Materials', 'Adsorption Cooling'], '68': ['Infrastructure', 'Adsorption'], '67': ['GCMC', 'Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Reticular Materials', 'Biogas Upgrading'],
  '66': ['GCMC', 'Enhanced Sampling', 'Adsorption', 'Cyclic Swing Adsorber', 'Carbon Capture'], '65': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials'], '64': ['Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Carbons', 'Carbon Monoxide Separation'], '63': ['Machine Learning', 'Data Curation', 'Characterization', 'Reticular Materials'],
  '62': ['GCMC', 'Machine Learning', 'Adsorption', 'Chiller', 'Reticular Materials', 'Adsorption Cooling'], '61': ['Diffusion', 'Polymers', 'Membranes', 'Organic Solvent Nanofiltration'], '60': ['GCMC', 'Infrastructure', 'Data Curation', 'Machine Learning', 'Adsorption', 'Reticular Materials'],
  '59': ['GCMC', 'Adsorption', 'Diffusion', 'Techno-Economic Analysis', 'Reticular Materials', 'Methane Storage'], '58': ['DFT', 'Diffusion', 'Reaction', 'Electrochemistry', 'Reticular Materials', 'Supercapacitor'], '57': ['Reaction', 'Diffusion', 'Electrochemistry', 'Oxides', 'Polymers', 'Secondary Battery'],
  '56': ['GCMC', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '55': ['GCMC', 'Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Zeolites', 'Natural Gas Sweetening'], '54': ['GCMC', 'Machine Learning', 'Infrastructure', 'Data Curation', 'Adsorption', 'Reticular Materials'], '53': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'],
  '52': ['GCMC', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Noble Gas Separation'], '51': ['GCMC', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '50': ['DFT', 'Machine Learning', 'Data Curation', 'Molecules'], '49': ['Diffusion', 'Reaction', 'Electrochemistry', 'Oxides', 'Carbons', 'Perovskites', 'Supercapacitor'],
  '48': ['Review'], '47': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '46': ['GCMC', 'Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Noble Gas Separation'], '45': ['Reaction', 'Reticular Materials'],
  '44': ['Reaction', 'Diffusion', 'Electrochemistry', 'Oxides', 'Polymers', 'Secondary Battery'], '43': ['Infrastructure', 'Characterization', 'Adsorption'], '42': ['Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials'],
  '41': ['Adsorption', 'Reaction', 'Zeolites', 'Catalysis'], '40': ['GCMC', 'Adsorption', 'Reticular Materials', 'Carbons', 'Graphene Oxide', 'Hydrogen Storage'], '39': ['DFT', 'Adsorption', 'Reaction', 'Molecules'], '38': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials'],
  '37': ['Review'], '36': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '35': ['GCMC', 'MD', 'Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Methane Storage'], '34': ['DFT', 'Carbons', 'Graphene Quantum Dots', 'Sensing'],
  '33': ['GCMC', 'Data Curation', 'Adsorption', 'Reticular Materials', 'SF6/N2 Separation'], '32': ['GCMC', 'Adsorption', 'Hydrogen Storage'],
  '31': ['Diffusion', 'Carbons', 'Membranes', 'Organic Liquid Separation'], '30': ['DFT', 'GCMC', 'MD', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Olefin/Paraffin Separation'], '29': ['DFT', 'Carbons', 'Graphene Quantum Dots', 'Sensing'], '28': ['Machine Learning', 'Distillation'],
  '27': ['Reaction', 'Air Pollution Control'], '26': ['Machine Learning', 'Data Curation', 'Characterization', 'Adsorption', 'Reticular Materials'], '25': ['Machine Learning', 'Distillation'], '24': ['Diffusion', 'Reaction', 'Molecules', 'Carbon Capture'],
  '23': ['DFT', 'Adsorption', 'Reaction', 'Carbons', 'Catalysis'], '22': ['Infrastructure', 'Data Curation', 'Reticular Materials'], '21': ['Review'],
  '20': ['DFT', 'Adsorption', 'Reticular Materials', 'Xylene Separation'], '19': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials', 'Carbons'], '18': ['GCMC', 'Adsorption', 'Cyclic Swing Adsorber', 'Reticular Materials', 'Carbon Capture'], '17': ['Review'],
  '16': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '15': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '14': ['GCMC', 'Adsorption', 'Reticular Materials', 'Carbon Capture'],
  '13': ['GCMC', 'Adsorption', 'Reticular Materials', 'Zeolites', 'Alkane Isomer Separation'], '12': ['GCMC', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '11': ['DFT', 'Data Curation', 'Reticular Materials'], '10': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'],
  '09': ['GCMC', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '08': ['DFT', 'GCMC', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '07': ['Adsorption', 'Reaction', 'Reticular Materials'],
  '06': ['GCMC', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Methane Storage'], '05': ['GCMC', 'Data Curation', 'Infrastructure', 'Adsorption', 'Reticular Materials'], '04': ['MD', 'Diffusion', 'Polymers'],
  '03': ['MD', 'Diffusion', 'Polymers'], '02': ['MD', 'Diffusion', 'Polymers'], '01': ['MD', 'Diffusion', 'Polymers']
};
