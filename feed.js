...
const NEWS_RAW = [
  ...
  { y: '2026', m: '02', parts: [P('Prof. Chung', 'p-chung'), ' was quoted in the Research Briefing by ', 'Nature Computational Science', '.'] },
  ...
  { y: '2026', m: '02', parts: [P('Sunghyun', 'm-yoon'), " successfully defended and received his Ph.D. in Chemical Engineering. He continues in the group as a Postdoctoral Researcher. Congratulations!"] },
  { y: '2026', m: '01', parts: [P('Haewon', 'a-haewon'), " graduates with a Master's degree in Chemical Engineering and joins SK hynix as an Engineer. Congratulations!"] },
  { y: '2025', m: '12', parts: [P('Sunghyun', 'm-yoon'), "'s paper on MPD integrated process modeling and optimization was published in ", J('Industrial & Engineering Chemistry Research', 'iecr', '10.1021/acs.iecr.5c03794'), '.'] },
  { y: '2025', m: '12', parts: [P('Guobin', 'a-guobin'), ' joined the MACE group (PI: Xiaoyan Li) in the Department of Chemistry at the National University of Singapore as a Postdoc.'] },
  { y: '2025', m: '11', parts: [P('Muhammad', 'm-hassan'), ', ', P('Sunghyun', 'm-yoon'), ', and ', P('Yu', 'm-chen'), "'s paper was published online in ", J('Computer Physics Communications', 'cpc', '10.1016/j.cpc.2025.109944'), '.'] },
  { y: '2025', m: '11', parts: [P('Changdon', 'm-shin'), ' and ', P('Sunghyun', 'm-yoon'), "'s paper was published online in ", J('Molecular Systems Design & Engineering', 'msde', '10.1039/D5ME00131E'), '.'] },
  { y: '2025', m: '10', parts: [P('Prof. Chung', 'p-chung'), ' was quoted in ', { t: 'Chemistry World’s article on neural networks for detecting crystal structure errors in MOF databases', journal: true, href: 'https://www.chemistryworld.com/news/neural-network-trained-to-classify-crystal-structure-errors-in-mof-and-other-databases/4022350.article' }, '.'] },
  { y: '2025', m: '10', parts: [P('Yu', 'm-chen'), ' and ', P('Guobin', 'a-guobin'), "'s paper was published online in ", J('Langmuir', 'lang', '10.1021/acs.langmuir.5c04369'), '.'] },
  { y: '2025', m: '08', parts: [P('Sunghyun', 'm-yoon'), ', ', P('Guobin', 'a-guobin'), ', and ', B('Yeji'), "'s paper was published online in ", J('Separation and Purification Technology', 'spt', '10.1016/j.seppur.2025.134786'), '.'] },
  { y: '2025', m: '08', parts: [P('Guobin', 'a-guobin'), ' and ', P('Pengyu', 'm-zhao'), "'s paper on MOFClassifier was published online in the ", J('Journal of the American Chemical Society', 'jacs', '10.1021/jacs.5c10126'), '.'] },
  { y: '2025', m: '05', parts: [P('Guobin', 'a-guobin'), ', ', P('Sunghyun', 'm-yoon'), ', and ', P('Haewon', 'a-haewon'), "'s paper on CoRE MOF DB was published online in ", J('Matter', 'matter', '10.1016/j.matt.2025.102140'), '.'] },
  { y: '2025', m: '02', parts: [P('Sunghyun', 'm-yoon'), "'s paper on techno-economic analysis of boil-off gas treatment using MOF was published in ", J('Chemical Engineering Journal', 'cej', '10.1016/j.cej.2025.160517'), '.'] },
  { y: '2024', m: '11', parts: [P('Haewon', 'a-haewon'), ' won the Grand Prize at the first Medical AI competition! Congratulations!'] },
  { y: '2024', m: '10', parts: ['Undergraduate students ', P('Taekgi', 'm-lee'), ' and ', B('Jaehoon'), ' won the Samsung AI Challenge! Congratulations!'] },
  { y: '2024', m: '10', parts: [P('Yu', 'm-chen'), ' published a paper on force field parameters for Mg-catecholate and hydrogen, and high-throughput screening of COFs, in ', J('ACS Applied Materials & Interfaces', 'ami', '10.1021/acsami.4c11953'), '.'] },
  { y: '2024', m: '09', parts: [P('Sunghyun', 'm-yoon'), ' and ', P('Muhammad', 'm-hassan'), "'s paper on pressure-vacuum swing adsorption modeling and optimization for a ternary system was published in ", J('Chemical Engineering Journal', 'cej', '10.1016/j.cej.2024.154116'), '.'] },
  { y: '2024', m: '09', parts: [P('Haewon', 'a-haewon'), ' published a collaborative paper on modeling aqueous zinc metal batteries with SKKU in ', J('Advanced Functional Materials', 'afm', '10.1002/adfm.202412577'), '.'] },
  { y: '2024', m: '08', parts: [P('Muhammad', 'm-hassan'), " successfully defended his Master's degree in Chemical Engineering. He continues in the group as a Ph.D. student. Congratulations!"] },
  { y: '2024', m: '06', parts: [P('Guobin', 'a-guobin'), "'s paper on a machine learning model to predict partial atomic charges in porous materials was published in the ", J('Journal of Chemical Theory and Computation', 'jctc', '10.1021/acs.jctc.4c00434'), '.'] },
  { y: '2024', m: '04', parts: [P('Yu', 'm-chen'), ' published a collaborative paper on modeling porous aromatic frameworks with Korea University in ', J('Advanced Materials', 'am', '10.1002/adma.202401739'), '.'] },
  { y: '2024', m: '04', parts: [P('Guobin', 'a-guobin'), ' and ', P('Haewon', 'a-haewon'), ' published a paper on machine learning models for low-GWP and molecular lifetime in the ', J('Journal of Physical Chemistry A', 'jpca', '10.1021/acs.jpca.3c07339'), '.'] },
...
const F = (no, title, authors, jk, journal, meta, code, doi) => ({
  no, title, authors, journal, journalKey: jk, jurl: doi ? DOI_URL(doi) : JU[jk], meta,
...
const PUBS = [
  ...
  F('60', 'CoRE MOF DB: a curated experimental metal-organic framework database with machine-learned properties for integrated material-process screening', 'Zhao, G., Brabson, L.M., Chheda, S., Huang, J., Kim, H., Liu, K., Mochida, K., Pham, T.D., Prerna, Terrones, G.G., Yoon, S., Zoubritzky, L., Coudert, F.-X., Haranczyk, M., Kulik, H.J., Moosavi, S.M., Sholl, D.S., Siepmann, J.I., Snurr, R.Q., Chung, Y.G.*', 'matter', 'Matter', ', 8, 102140 (2025)', 'https://github.com/Chung-Research-Group/CoRE-MOF-Tools', '10.1016/j.matt.2025.102140'),
  ...
  F('58', 'Hierarchically Structured Conductive Lanthanide Metal Organic Framework Nanorods for Ultrastable Flexible Magnesium Ion Capacitors', 'Park, H.R., Jang, G., Byun, J.S., Park, Y., Kim, W.I., Lee, S.J., Chung, Y.G., Jung, Y.M., Park, H.S.*', 'afm', 'Advanced Functional Materials', ', 35, 2417288 (2025)', null, '10.1002/adfm.202417288'),
  F('57', 'Polyoxometalate initiated in-situ conformal coating of multifunctional hybrid artificial layers for high-performance zinc metal anodes', 'Byun, J.S., Kim, W.I., Baek, S.H., Hao, F., Kim, H., Chung, Y.G., Li, L.X., Zhang, R., Park, H.S.*', 'afm', 'Advanced Functional Materials', ', 35, 2412577 (2025)', null, '10.1002/adfm.202412577'),
  F('56', 'Computational Exploration of Adsorption-based Hydrogen Storage in Mg-alkoxide Functionalized COFs: Force-field and Machine Learning Models', 'Chen, Y., Zhao, G., Yoon, S., Habibi, P., Hong, C.S., Li, S., Moultos, O.A., Dey, P., Vlugt, T.J.H., Chung, Y.G.*', 'ami', 'ACS Applied Materials & Interfaces', ', 16, 61995–62009 (2024)', null, '10.1021/acsami.4c11953'),
  ...
  F('51', 'High Hydrogen Storage in Trigonal Prismatic Monomer-based Highly Porous Aromatic Frameworks', 'Kim, D.W.#, Chen, Yu#, Kim, H., Kim, N., Lee, Y.H., Oh, H., Chung, Y.G.*, Hong, C.S.*', 'am', 'Advanced Materials', ', 36, 2401739 (2024)', null, '10.1002/adma.202401739'),
...
const PUB_TOPICS = {
  ...
  '62': ['Grand Canonical Monte Carlo', 'Machine Learning', 'Adsorption', 'Chiller', 'Reticular Materials', 'Adsorption Cooling'], '61': ['Diffusion', 'Polymers', 'Membranes', 'Organic Solvent Nanofiltration'], '60': ['Grand Canonical Monte Carlo', 'Infrastructure', 'Data Curation', 'Machine Learning', 'Adsorption', 'Reticular Materials'],
  '59': ['Grand Canonical Monte Carlo', 'Adsorption', 'Diffusion', 'Techno-Economic Analysis', 'Reticular Materials', 'Methane Storage'], '58': ['Density Functional Theory', 'Diffusion', 'Reaction', 'Electrochemistry', 'Reticular Materials', 'Supercapacitor'], '57': ['Reaction', 'Diffusion', 'Electrochemistry', 'Oxides', 'Polymers', 'Secondary Battery'],
  '56': ['Grand Canonical Monte Carlo', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '55': ['Grand Canonical Monte Carlo', 'Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Zeolites', 'Natural Gas Sweetening'], '54': ['Grand Canonical Monte Carlo', 'Machine Learning', 'Infrastructure', 'Data Curation', 'Adsorption', 'Reticular Materials'], '53': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'],
  '52': ['Grand Canonical Monte Carlo', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Noble Gas Separation'], '51': ['Grand Canonical Monte Carlo', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '50': ['Density Functional Theory', 'Machine Learning', 'Data Curation', 'Molecules'], '49': ['Diffusion', 'Reaction', 'Electrochemistry', 'Oxides', 'Carbons', 'Perovskites', 'Supercapacitor'],
  '48': ['Review'], '47': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '46': ['Grand Canonical Monte Carlo', 'Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Noble Gas Separation'], '45': ['Reaction', 'Reticular Materials'],
  '44': ['Reaction', 'Diffusion', 'Electrochemistry', 'Oxides', 'Polymers', 'Secondary Battery'], '43': ['Infrastructure', 'Material Characterization', 'Adsorption'], '42': ['Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials'],
  '41': ['Adsorption', 'Reaction', 'Zeolites', 'Catalysis'], '40': ['Grand Canonical Monte Carlo', 'Adsorption', 'Reticular Materials', 'Carbons', 'Graphene Oxide', 'Hydrogen Storage'], '39': ['Density Functional Theory', 'Adsorption', 'Reaction', 'Molecules'], '38': ['Grand Canonical Monte Carlo', 'Material Characterization', 'Adsorption', 'Reticular Materials'],
  '37': ['Review'], '36': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '35': ['Grand Canonical Monte Carlo', 'Molecular Dynamics', 'Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Methane Storage'], '34': ['Density Functional Theory', 'Carbons', 'Graphene Quantum Dots', 'Sensing'],
  '33': ['Grand Canonical Monte Carlo', 'Data Curation', 'Adsorption', 'Reticular Materials', 'SF6/N2 Separation'], '32': ['Grand Canonical Monte Carlo', 'Adsorption', 'Hydrogen Storage'],
  '31': ['Diffusion', 'Carbons', 'Membranes', 'Organic Liquid Separation'], '30': ['Density Functional Theory', 'Grand Canonical Monte Carlo', 'Molecular Dynamics', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Olefin/Paraffin Separation'], '29': ['Density Functional Theory', 'Carbons', 'Graphene Quantum Dots', 'Sensing'], '28': ['Machine Learning', 'Distillation'],
  '27': ['Reaction', 'Air Pollution Control'], '26': ['Machine Learning', 'Data Curation', 'Material Characterization', 'Adsorption', 'Reticular Materials'], '25': ['Machine Learning', 'Distillation'], '24': ['Diffusion', 'Reaction', 'Molecules', 'Carbon Capture'],
  '23': ['Density Functional Theory', 'Adsorption', 'Reaction', 'Carbons', 'Catalysis'], '22': ['Infrastructure', 'Data Curation', 'Reticular Materials'], '21': ['Review'],
  '20': ['Density Functional Theory', 'Adsorption', 'Reticular Materials', 'Xylene Separation'], '19': ['Grand Canonical Monte Carlo', 'Material Characterization', 'Adsorption', 'Reticular Materials', 'Carbons'], '18': ['Grand Canonical Monte Carlo', 'Adsorption', 'Cyclic Swing Adsorber', 'Reticular Materials', 'Carbon Capture'], '17': ['Review'],
  '16': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '15': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '14': ['Grand Canonical Monte Carlo', 'Adsorption', 'Reticular Materials', 'Carbon Capture'],
  '13': ['Grand Canonical Monte Carlo', 'Adsorption', 'Reticular Materials', 'Zeolites', 'Alkane Isomer Separation'], '12': ['Grand Canonical Monte Carlo', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '11': ['Density Functional Theory', 'Data Curation', 'Reticular Materials'], '10': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'],
  '09': ['Grand Canonical Monte Carlo', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '08': ['Density Functional Theory', 'Grand Canonical Monte Carlo', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '07': ['Adsorption', 'Reaction', 'Reticular Materials'],
