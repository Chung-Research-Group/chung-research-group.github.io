...
const PUB_TOPICS = {
  '72': ['Review'], '71': ['Machine Learning', 'LLM', 'Data Curation', 'Transport', 'Electrochemistry', 'Electrolytes', 'Energy Storage'], '70': ['Review'],
  '69': ['Adsorption', 'Transport', 'Device', 'Reticular Materials', 'Adsorption Cooling'], '68': ['Infrastructure', 'Adsorption', 'Statistical Mechanics'], '67': ['GCMC', 'Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Reticular Materials', 'Biogas Upgrading', 'Gas Separation'],
  '66': ['GCMC', 'Adsorption', 'Statistical Mechanics', 'Cyclic Swing Adsorber', 'Gas Separation'], '65': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials'], '64': ['Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Carbons', 'Gas Separation'], '63': ['Machine Learning', 'Data Curation', 'Characterization', 'Reticular Materials'],
  '62': ['GCMC', 'Machine Learning', 'Adsorption', 'Device', 'Reticular Materials', 'Adsorption Cooling'], '61': ['Transport', 'Polymers', 'Membranes', 'Membrane Separation'], '60': ['GCMC', 'Infrastructure', 'Data Curation', 'Machine Learning', 'Adsorption', 'Reticular Materials'],
  '59': ['GCMC', 'Adsorption', 'Transport', 'Techno-Economic Analysis', 'Reticular Materials', 'Methane Storage'], '58': ['DFT', 'Transport', 'Reaction', 'Electrochemistry', 'Device', 'Reticular Materials', 'Energy Storage'], '57': ['Reaction', 'Transport', 'Electrochemistry', 'Device', 'Oxides', 'Polymers', 'Energy Storage'],
  '56': ['GCMC', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '55': ['GCMC', 'Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Zeolites', 'Gas Separation'], '54': ['GCMC', 'Machine Learning', 'Infrastructure', 'Data Curation', 'Adsorption', 'Reticular Materials'], '53': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'],
  '52': ['GCMC', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Gas Separation'], '51': ['GCMC', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '50': ['DFT', 'Machine Learning', 'Data Curation', 'Molecules'], '49': ['Transport', 'Reaction', 'Electrochemistry', 'Device', 'Oxides', 'Carbons', 'Perovskites', 'Energy Storage'],
  '48': ['Review'], '47': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '46': ['GCMC', 'Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Gas Separation'], '45': ['Reaction', 'Reticular Materials'],
  '44': ['Reaction', 'Transport', 'Electrochemistry', 'Device', 'Oxides', 'Polymers', 'Energy Storage'], '43': ['Infrastructure', 'Characterization', 'Adsorption'], '42': ['Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials'],
  ...
  '33': ['GCMC', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Gas Separation'], '32': ['GCMC', 'Adsorption', 'Hydrogen Storage'],
  '31': ['Transport', 'Carbons', 'Membranes', 'Membrane Separation'], '30': ['DFT', 'GCMC', 'MD', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Gas Separation'], '29': ['DFT', '2D', 'Carbons', 'Sensing'], '28': ['Machine Learning', 'Distillation'],
  ...
  '20': ['DFT', 'Adsorption', 'Reticular Materials', 'Gas Separation'], '19': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials', 'Carbons'], '18': ['GCMC', 'Adsorption', 'Cyclic Swing Adsorber', 'Reticular Materials', 'Carbon Capture'], '17': ['Review'],
  ...
  '13': ['GCMC', 'Adsorption', 'Reticular Materials', 'Zeolites', 'Gas Separation'], '12': ['GCMC', 'Adsorption', 'Reticular Materials', 'Carbon Capture'], '11': ['DFT', 'Data Curation', 'Reticular Materials'], '10': ['Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'],
