...
const PUB_TOPICS = {
  '72': ['Review'], '71': ['Machine Learning', 'LLM', 'Data Curation', 'Transport', 'Electrochemistry', 'Electrolytes', 'Secondary Battery'], '70': ['Review'],
  '69': ['Adsorption', 'Transport', 'Chiller', 'Reticular Materials', 'Adsorption Cooling'], '68': ['Infrastructure', 'Adsorption', 'Statistical Mechanics'], '67': ['GCMC', 'Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Reticular Materials', 'Biogas Upgrading'],
  '66': ['GCMC', 'Adsorption', 'Statistical Mechanics', 'Cyclic Swing Adsorber', 'Carbon Capture'], '65': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials'], '64': ['Adsorption', 'Techno-Economic Analysis', 'Cyclic Swing Adsorber', 'Carbons', 'Carbon Monoxide Separation'], '63': ['Machine Learning', 'Data Curation', 'Characterization', 'Reticular Materials'],
  '62': ['GCMC', 'Machine Learning', 'Adsorption', 'Chiller', 'Reticular Materials', 'Adsorption Cooling'], '61': ['Transport', 'Polymers', 'Membranes', 'Organic Solvent Nanofiltration'], '60': ['GCMC', 'Infrastructure', 'Data Curation', 'Machine Learning', 'Adsorption', 'Reticular Materials'],
  '59': ['GCMC', 'Adsorption', 'Transport', 'Techno-Economic Analysis', 'Reticular Materials', 'Methane Storage'], '58': ['DFT', 'Transport', 'Reaction', 'Electrochemistry', 'Reticular Materials', 'Supercapacitor'], '57': ['Reaction', 'Transport', 'Electrochemistry', 'Oxides', 'Polymers', 'Secondary Battery'],
  ...
  '52': ['GCMC', 'Machine Learning', 'Adsorption', 'Reticular Materials', 'Noble Gas Separation'], '51': ['GCMC', 'Adsorption', 'Reticular Materials', 'Hydrogen Storage'], '50': ['DFT', 'Machine Learning', 'Data Curation', 'Molecules'], '49': ['Transport', 'Reaction', 'Electrochemistry', 'Oxides', 'Carbons', 'Perovskites', 'Supercapacitor'],
  ...
  '44': ['Reaction', 'Transport', 'Electrochemistry', 'Oxides', 'Polymers', 'Secondary Battery'], '43': ['Infrastructure', 'Characterization', 'Adsorption'], '42': ['Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials'],
  '41': ['Adsorption', 'Reaction', '2D', 'Zeolites', 'Catalysis'], '40': ['GCMC', 'Adsorption', 'Reticular Materials', 'Carbons', 'Hydrogen Storage'], '39': ['DFT', 'Adsorption', 'Reaction', 'Molecules'], '38': ['GCMC', 'Characterization', 'Adsorption', 'Reticular Materials'],
  '37': ['Review'], '36': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '35': ['GCMC', 'MD', 'Machine Learning', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Methane Storage'], '34': ['DFT', '2D', 'Carbons', 'Sensing'],
  '33': ['GCMC', 'Data Curation', 'Adsorption', 'Reticular Materials', 'SF6/N2 Separation'], '32': ['GCMC', 'Adsorption', 'Hydrogen Storage'],
  '31': ['Transport', 'Carbons', 'Membranes', 'Organic Liquid Separation'], '30': ['DFT', 'GCMC', 'MD', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Olefin/Paraffin Separation'], '29': ['DFT', '2D', 'Carbons', 'Sensing'], '28': ['Machine Learning', 'Distillation'],
  '27': ['Reaction', 'Air Pollution Control'], '26': ['Machine Learning', 'Data Curation', 'Characterization', 'Adsorption', 'Reticular Materials'], '25': ['Machine Learning', 'Distillation'], '24': ['Transport', 'Reaction', 'Statistical Mechanics', 'Molecules', 'Carbon Capture'],
  ...
  '16': ['Adsorption', 'Reaction', '2D', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '15': ['Adsorption', 'Reaction', 'Reticular Materials', 'CO2 Conversion', 'Catalysis'], '14': ['GCMC', 'Adsorption', 'Reticular Materials', 'Carbon Capture'],
  ...
  '06': ['GCMC', 'Data Curation', 'Adsorption', 'Reticular Materials', 'Methane Storage'], '05': ['GCMC', 'Data Curation', 'Infrastructure', 'Adsorption', 'Reticular Materials'], '04': ['MD', 'Transport', 'Polymers'],
