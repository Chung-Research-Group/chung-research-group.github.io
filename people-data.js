...
window.MTAP_PEOPLE = () => ({
  groups: [
    ...
    { title: 'Graduate Students', kr: '대학원생', people: [
      { slot: 'm-chen', photo: 'ph-chen', name: 'Chen, Yu', kr: '첸 유, 陈豫', program: 'Ph.D. Program', interests: 'Atoms/Electrons · AI & Data', scholar: 'https://scholar.google.com/citations?user=2z24SzAAAAJ', github: 'https://github.com/DrakeChan', linkedin: 'https://www.linkedin.com/in/yu-chen-913344248', edu: 'B.S. New Energy Science & Technology, Huazhong University of Science and Technology (2020)' },
